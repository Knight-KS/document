...
### 定义服务接口
```
package com.vvdd.hello.dubbo.service.user.api;
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.dubbo.service.user.provider.HelloDubboServiceUserProviderApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
`com.vvdd:hello-dubbo-service-user-api:1.0.0-SNAPSHOT`：刚才创建的接口项目，如果无法依赖别忘记先 `mvn clean install` 到本地仓库。
...
dubbo:
  ...
  scan:
    basePackages: com.vvdd.hello.dubbo.service.user.provider.api
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <artifactId>spring-boot-maven-plugin</artifactId>
                <configuration>
                    <mainClass>com.vvdd.hello.dubbo.service.user.consumer.HelloDubboServiceUserConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
dubbo:
  scan:
    basePackages: com.vvdd.hello.dubbo.service.user.consumer.controller
  ## ApplicationConfig Bean
  application:
