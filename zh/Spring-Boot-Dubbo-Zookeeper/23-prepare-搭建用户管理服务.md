...
## 配置 Hystrix Servlet
```
package com.vvdd.myshop.commons.dubbo.config.servlet;
...
### TbUserService
```
package com.vvdd.myshop.service.user.api;

import com.vvdd.myshop.commons.domain.TbUser;
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.myshop.service.user.provider.MyShopServiceUserProviderApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
### Application
```
package com.vvdd.myshop.service.user.provider;
...
### TbUserServiceImpl
```
package com.vvdd.myshop.service.user.provider.api.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.vvdd.myshop.commons.domain.TbUser;
import com.vvdd.myshop.commons.mapper.TbUserMapper;
import com.vvdd.myshop.service.user.api.TbUserService;
...
dubbo:
  ...
  scan:
    basePackages: com.vvdd.myshop.service.user.provider.api.impl
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <artifactId>spring-boot-maven-plugin</artifactId>
                <configuration>
                    <mainClass>com.vvdd.myshop.service.user.consumer.MyShopServiceUserConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
### Application
```
package com.vvdd.myshop.service.user.consumer;
...
### TbUserController
```
package com.vvdd.myshop.service.user.consumer.controller;
...
dubbo:
  scan:
    basePackages: com.vvdd.myshop.service.user.consumer.controller
  ## ApplicationConfig Bean
  application:
