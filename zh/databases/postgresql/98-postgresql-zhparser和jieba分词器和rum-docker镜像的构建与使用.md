...
#                rum模块
#       CREATED: 06/21/2019 05:00:38 PM
#===============================================================================
...
```
[root@hadoop tmp]# docker exec -it postgres bash
...
services:
  postgres:
    ...
    volumes:
      ...
      - /usr/local/docker/postgresql_scws:/opt
      - /usr/local/docker/postgresql_scws/config/postgresql.conf:/etc/postgresql/postgresql.conf
volumes:
  postgres-data:
...
services:
  postgres:
    ...
    ports:
      - 5432:5432
    volumes:
      - /usr/local/docker/postgresql/postgres-data:/var/lib/postgresql/data

```


tar -zcvf vvdd.tar.gz /home/wwwroot/www.vvdd.top/web/vvdd/
