    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.itoken.zuul.ZuulApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
spring:
  cloud:
    config:
      ...
      name: itoken-client-eureka, itoken-client-zipkin, itoken-client-admin, itoken-zuul
      label: master
      profile: dev
```
## bootstrap-prod.yml
