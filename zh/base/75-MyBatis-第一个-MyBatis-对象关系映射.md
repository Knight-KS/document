...
```
package com.leizhenjie.my.shop.domain;
...
```
package com.leizhenjie.my.shop.web.admin.dao;

import com.leizhenjie.my.shop.domain.TbUser;
...
## 定义业务逻辑接口
```
package com.leizhenjie.my.shop.web.admin.service;
...
## 实现业务逻辑接口
```
package com.leizhenjie.my.shop.web.admin.service.impl;

import com.leizhenjie.my.shop.domain.TbUser;
import com.leizhenjie.my.shop.web.admin.dao.TbUserDao;
import com.leizhenjie.my.shop.web.admin.service.TbUserService;
...
<mapper namespace="com.leizhenjie.my.shop.web.admin.dao.TbUserDao">
...
```
package com.leizhenjie.my.shop.web.admin.service.test;
