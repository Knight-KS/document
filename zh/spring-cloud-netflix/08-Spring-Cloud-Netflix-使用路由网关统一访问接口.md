    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.zuul.ZuulApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```
package com.vvdd.hello.spring.cloud.zuul;
...
## 配置网关路由失败时的回调
```
package com.vvdd.hello.spring.cloud.zuul.fallback;
