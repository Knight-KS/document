    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.web.admin.feign.WebAdminFeignApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```
package com.vvdd.hello.spring.cloud.web.admin.feign;
...
## 创建测试用的 Controller
```
package com.vvdd.hello.spring.cloud.web.admin.feign.controller;
