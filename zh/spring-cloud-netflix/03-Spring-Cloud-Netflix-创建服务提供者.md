    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.service.admin.ServiceAdminApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```
package com.vvdd.hello.spring.cloud.service.admin;
...
## Controller
```
package com.vvdd.hello.spring.cloud.service.admin.controller;
