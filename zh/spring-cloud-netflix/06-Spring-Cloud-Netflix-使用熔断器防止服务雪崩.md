...
```
package com.vvdd.hello.spring.cloud.web.admin.ribbon.service;
...
```
package com.vvdd.hello.spring.cloud.web.admin.feign.service;

import com.vvdd.hello.spring.cloud.web.admin.feign.service.hystrix.AdminServiceHystrix;
...
```
package com.vvdd.hello.spring.cloud.web.admin.feign.service.hystrix;

import com.vvdd.hello.spring.cloud.web.admin.feign.service.AdminService;
