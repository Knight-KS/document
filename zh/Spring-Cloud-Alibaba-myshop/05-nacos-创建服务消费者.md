    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.NacosConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.config;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.controller;
