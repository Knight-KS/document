    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.alibaba.rocketmq.consumer.RocketMQConsumerApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.vvdd.hello.spring.cloud.alibaba.rocketmq.consumer.receive;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.rocketmq.consumer;
