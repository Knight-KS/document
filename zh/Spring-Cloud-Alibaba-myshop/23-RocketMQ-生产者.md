    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.alibaba.rocketmq.provider.RocketMQProviderApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
## [#](https://www.vvdd.com/zh/spring-cloud-alibaba/RocketMQ-生产者.html#消息生产者服务)消息生产者服务

```java
package com.vvdd.hello.spring.cloud.alibaba.rocketmq.provider.service;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.rocketmq.provider;

import com.vvdd.hello.spring.cloud.alibaba.rocketmq.provider.service.ProviderService;
import org.springframework.beans.factory.annotation.Autowired;
