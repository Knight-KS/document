    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.NacosConsumerFeignApplication</mainClass>
                </configuration>
            </plugin>
        </plugins>
    </build>
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.service;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.controller;

import com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.service.EchoService;
...
![img](https://www.vvdd.com/assets1/Lusifer_20190106144323.png)
