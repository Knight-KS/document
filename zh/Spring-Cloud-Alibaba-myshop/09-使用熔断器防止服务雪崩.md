...
![img](../../static/zh/spring-cloud-alibaba-myshop/09-001.png)

较底层的服务如果出现故障，会导致连锁故障。当对特定的服务的调用的不可用达到一个阀值熔断器将会被打开。

![img](../../static/zh/spring-cloud-alibaba-myshop/09-002.png)
...
import com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.service.fallback.EchoServiceFallback;
...
```java
package com.vvdd.hello.spring.cloud.alibaba.nacos.consumer.feign.service.fallback;
