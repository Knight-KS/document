...
@MapperScan(basePackages = "com.vvdd.hello.spring.boot.mapper")
...
import com.vvdd.hello.spring.boot.entity.TbUser;
import com.vvdd.hello.spring.boot.mapper.TbUserMapper;
...
public class MyBatisTests {
    ...
    public void testInsert() {
        ...
        tbUser.setUsername("Leizhenjie");
        tbUser.setPassword("123456");
        tbUser.setPhone("15888888888");
        tbUser.setEmail("zhenjie_lei@qq.com");
    ...
    public void testDelete() {
        // 构造条件，等同于 DELETE from tb_user WHERE username = 'Leizhenjie'
        Example example = new Example(TbUser.class);
        example.createCriteria().andEqualTo("username", "Leizhenjie");
    ...
    public void testUpdate() {
        ...
        // 构造一条测试数据
        TbUser tbUser = new TbUser();
        tbUser.setUsername("LeizhenjieNew");
        tbUser.setPassword("123456");
        tbUser.setPhone("15888888888");
        tbUser.setEmail("zhenjie_lei@qq.com");
        tbUser.setCreated(new Date());
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <mainClass>com.vvdd.hello.spring.boot.HelloSpringBootApplication</mainClass>
                </configuration>
            </plugin>
