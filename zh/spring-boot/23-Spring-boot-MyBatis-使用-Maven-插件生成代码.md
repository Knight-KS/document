...
<generatorConfiguration>
    ...
    <context id="Mysql" targetRuntime="MyBatis3Simple" defaultModelType="flat">
        ...
        <plugin type="tk.mybatis.mapper.generator.MapperPlugin">
            <property name="mappers" value="com.vvdd.utils.MyMapper"/>
        </plugin>
        ...
        <!-- 配置实体类存放路径 -->
        <javaModelGenerator targetPackage="com.vvdd.hello.spring.boot.entity" targetProject="src/main/java"/>
        ...
        <!-- 配置 DAO 存放路径 -->
        <javaClientGenerator
                targetPackage="com.vvdd.hello.spring.boot.mapper"
