...
ENTRYPOINT ["dockerize", "-timeout", "5m", "-wait", "tcp://192.168.81.128:8888", "java", "-Djava.security.egd=file:/dev/./urandom", "-jar", "/app/app.jar", "--spring.profiles.active=prod"]
