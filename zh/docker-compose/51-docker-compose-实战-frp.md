...
>
> https://github.com/cloverzrg/frpc-docker
>
...
services:
  frps:
    restart: always
    image: cloverzrg/frps-docker:0.36.0
    container_name: frps
    network_mode: "host"
    #ports:
    #  - 81:80
    volumes:
      - ./data/conf/frps.ini:/conf/frps.ini
```
...
services:
  frpc:
    restart: always
    image: cloverzrg/frpc-docker:0.36.0
    container_name: frpc
    network_mode: "host"
    #ports:
    #  - 81:80
    volumes:
      - ./data/conf/frpc.ini:/conf/frpc.ini
```
